...
<script>
	...
	export default {
		...
		computed: {
			boxStyle(){
				const style = {};
				style.background = `rgb(${this.bgcolor.r},${this.bgcolor.g},${this.bgcolor.b})`;
				console.log(this.$uv.addStyle(style))
				return this.$uv.addStyle(style);
			}
		},
		data() {
			return {
